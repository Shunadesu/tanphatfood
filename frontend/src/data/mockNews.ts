...
export const mockNews: NewsArticle[] = [
  {
    ...
    description:
      'Trung Quốc mở rộng hạn ngạch nhập khẩu sầu riêng Việt Nam, mở ra cơ hội tăng trưởng mạnh mẽ cho ngành trái cây xuất khẩu năm 2025.',
    image: '/images/news/durian.png',
    date: '15.10.2025',
    slug: 'co-hoi-xuat-khau-sau-rieng-viet-sang-thi-truong-trung-quoc',
  ...
  },
  {
    ...
    description:
      'Sản phẩm trái cây sấy tự nhiên đang được ưa chuộng tại Hàn Quốc, Nhật Bản, Singapore - cơ hội lớn cho doanh nghiệp Việt Nam mở rộng xuất khẩu.',
    image: '/images/news/dried-fruits.jpg',
    date: '15.10.2025',
    slug: 'xu-huong-trai-cay-say-viet-nam-trong-thi-truong-chau-a',
    author: 'Tấn Phát Food',
    category: 'Thị trường xuất khẩu',
    content: `
  ...
  },
  {
    ...
    description:
      'Tìm hiểu vì sao tiêu chuẩn GlobalG.A.P trở thành "chìa khóa" giúp nông sản Việt chinh phục các thị trường khó tính như EU và Nhật Bản.',
    image: '/images/news/globalgap.jpg',
    date: '15.10.2025',
    slug: 'globalgap-tieu-chuan-vang-cho-nong-san-xuat-khau',
    author: 'Tấn Phát Food',
    category: 'Tiêu chuẩn chất lượng',
    content: `
  ...
  },
  {
    ...
    description:
      'Bột trái cây từ nông sản Việt đang được nhiều doanh nghiệp F&B lựa chọn nhờ hương vị tự nhiên, giá cạnh tranh và nguồn cung ứng ổn định từ Tấn Phát Food.',
    image: '/images/news/fruit-powder.jpg',
    date: '15.10.2025',
    slug: 'bot-trai-cay-giai-phap-nguyen-lieu-tu-nhien-cho-nganh-fb',
    author: 'Tấn Phát Food',
    category: 'Sản phẩm',
    content: `
  ...
  },
  {
    ...
    description:
      'Tấn Phát Food áp dụng công nghệ đóng gói tiên tiến, giúp giữ trọn độ tươi và hương vị tự nhiên trong suốt hành trình vận chuyển quốc tế.',
    image: '/images/news/packaging.jpg',
    date: '15.10.2025',
    slug: 'quy-trinh-dong-goi-va-bao-quan-trai-cay-dat-chuan-xuat-khau',
    author: 'Tấn Phát Food',
  ...
  },
  {
    ...
    description:
      'Kim ngạch xuất khẩu nông sản 2025 dự kiến tăng trưởng mạnh nhờ nhu cầu tiêu dùng xanh, an toàn và sản phẩm có chứng nhận nguồn gốc rõ ràng.',
    image: '/images/news/export-market.png',
    date: '15.10.2025',
    slug: 'thi-truong-xuat-khau-trai-cay-viet-2025-nhung-tin-hieu-tich-cuc',
    author: 'Tấn Phát Food',
    category: 'Thị trường xuất khẩu',
    content: `
