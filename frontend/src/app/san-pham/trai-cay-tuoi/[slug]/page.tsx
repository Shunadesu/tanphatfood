    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => router.push('/san-pham/trai-cay-tuoi')}
      ...
      <main>
        ...
        <HeroSectionWithBreadcrumb
          ...
          breadcrumbItems={[
            ...
            { label: 'Trái cây tươi xuất khẩu', href: '/san-pham/trai-cay-tuoi' },
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            ...
            <div className="mb-8 md:mb-12">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#00652E] mb-4">
                {product.title} tươi xuất khẩu Tấn Phát
              </h1>
                  ...
                  {product.markets && product.markets.length > 0 && (
                    <div className="mb-6">
                      ...
                      <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-4">
                        Tấn Phát Food hiện đang xuất khẩu {product.title} tươi đến các thị trường:
                      </p>
