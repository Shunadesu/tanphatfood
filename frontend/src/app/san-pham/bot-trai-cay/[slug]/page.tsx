...
import { getPowderProductBySlug } from '@/data/mockPowderProducts'
import { LiaTelegramPlane } from 'react-icons/lia'
import FloatingContactButtons from '@/components/FloatingContactButtons'
import ScrollToTop from '@/components/ScrollToTop'
import HeroSectionWithBreadcrumb from '@/components/HeroSectionWithBreadcrumb'

export default function PowderProductDetailPage() {
  const params = useParams()
  const router = useRouter()
  const slug = params?.slug as string
  const [selectedImage, setSelectedImage] = useState(0)

  const product = getPowderProductBySlug(slug)
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => router.push('/san-pham/bot-trai-cay')}
      ...
      <main>
        ...
        <HeroSectionWithBreadcrumb
          ...
          breadcrumbItems={[
            ...
            { label: 'Bột trái cây xuất khẩu', href: '/san-pham/bot-trai-cay' },
