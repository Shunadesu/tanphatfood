...
export default function NewsNew() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    setFormData(prev => {
      ...
      // Xử lý slug khi thay đổi title
      if (name === 'title') {
        // Nếu xóa title (value rỗng), xóa cả slug
        if (!value || value.trim() === '') {
          updated.slug = ''
        }
      }
  ...
  const handleGenerateSlug = () => {
    if (formData.title && formData.title.trim()) {
      ...
      alert('Vui lòng nhập tiêu đề tin tức trước')
    }
  }
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    title="Tạo slug từ tiêu đề tin tức"
                  >
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Click nút "Tạo slug" để tự động tạo slug từ tiêu đề tin tức
                </p>
              </div>
